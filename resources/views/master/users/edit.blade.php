        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 p-6 bg-white dark:bg-card-dark rounded-2xl shadow-sm border border-slate-200 dark:border-slate-800">
            ...
            <div class="md:col-span-2 space-y-3">
                ...
                <div class="flex flex-wrap gap-4 p-4 bg-slate-50 dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800">
                    ...
                    <label class="flex items-center gap-2 cursor-pointer">
                        <input type="checkbox" name="allowed_apps[]" value="kpi-netto" class="rounded border-slate-300 text-primary focus:ring-primary" {{ in_array('kpi-netto', $allowed) ? 'checked' : '' }}>
                        <span class="text-sm font-medium">KPI Netto</span>
                    </label>
                    <label class="flex items-center gap-2 cursor-pointer">
                        <input type="checkbox" name="allowed_apps[]" value="kpi-lilin" class="rounded border-slate-300 text-primary focus:ring-primary" {{ in_array('kpi-lilin', $allowed) ? 'checked' : '' }}>
